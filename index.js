...
import { checkToken, getSomeDataListFrom1C, logout, getGetParadocsMenuFrom1C, getGetParadocsTextsFrom1C, putSaveParadocsTextFrom1C, putSaveParadocsTextsFrom1C, checkUserAuthPost, getBidDataFrom1C, pushBidButtonOn1C, getReportResultFrom1C, getGetBidsListFrom1C, GetTaskboardDataFrom1C, pushTaskButtonTo1C, getGetTasksListFrom1C, getNotesDataFrom1C, PushNoteStatusOn1C, getNoteDataFrom1C, saveNoteDataIn1C, getTaskDataFrom1C } from './server/connectTo1C.js';
...
app.post('/GetNotesData', checkToken, getNotesDataFrom1C);
app.post('/PushNoteStatus', checkToken, PushNoteStatusOn1C);
app.post('/GetNoteData', checkToken, getNoteDataFrom1C);
app.post('/SaveNoteData', checkToken, saveNoteDataIn1C);
app.post('/GetTaskData', checkToken, getTaskDataFrom1C);
app.post('/getReport', checkToken, getReportResultFrom1C);
app.post('/GetDataList', checkToken, getSomeDataListFrom1C);
...
app.get('/notes', sendIndex);
app.get('/notes/:noteNumber', sendIndex);
